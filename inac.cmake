...
function(inac_add_tests)
    ...
    file(GLOB_RECURSE src LIST_DIRECTORIES false ${CMAKE_SOURCE_DIR}/tests/test_*.c ${CMAKE_SOURCE_DIR}/tests/helper_*.c ${CMAKE_SOURCE_DIR}/tests/test_*.cxx ${CMAKE_SOURCE_DIR}/tests/helper_*.cxx ${CMAKE_SOURCE_DIR}/tests/test_*.cpp ${CMAKE_SOURCE_DIR}/tests/helper_*.cpp)
