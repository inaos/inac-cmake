...
function(inac_add_tests)
    ...
    file(GLOB_RECURSE src LIST_DIRECTORIES false  ${CMAKE_SOURCE_DIR}/tests/test_*.c ${CMAKE_SOURCE_DIR}/tests/helper_*.c src ${CMAKE_SOURCE_DIR}/tests/test_*.cxx ${CMAKE_SOURCE_DIR}/tests/helper_*.cxx src ${CMAKE_SOURCE_DIR}/tests/test_*.cpp ${CMAKE_SOURCE_DIR}/tests/helper_*.cpp)
...
function(inac_artifact_name_only name output_var)
    if (MSVC)
        ...
        elseif($ENV{VisualStudioVersion} STREQUAL "17.0")
            string(APPEND ARTIFACT_NAME "${name}-${CMAKE_SYSTEM_NAME}_vs22-${INAC_TARGET_ARCH}-${CMAKE_BUILD_TYPE}")
	else()
            message(FATAL_ERROR "Unknown Visual-Studio version: $ENV{VisualStudioVersion}")
        endif()
    else()
